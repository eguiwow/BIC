...
def importGPX(gpxFile, gpxLayerFilter, pgConn):
    ...
    def ogrAppendFeatures(gpxFile, sourceLayer, destinationLayer):
        ...
        print (format(sourceLayer.GetName(), sourceLayer.GetFeatureCount()))
